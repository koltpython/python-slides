	...
	\section{Logistics}
		\begin{frame}{Who Are We?}
			\begin{columns}
				...
				\medskip
				\visible<5->{
					\includegraphics[width=2.0cm]{images/firat.jpg}\\
					Fırat Tamur\\
				}
				\column{2.5cm}
				\centering
				...
				\medskip
				\visible<6->{
					\includegraphics[width=2.0cm]{images/ayse.jpg}\\
					Ayşe Turşucular\\
				}
				\column{2.5cm}
				\centering
				...
				\medskip
				\visible<7->{
					\includegraphics[width=2.0cm]{images/haluk.jpg}\\
					Haluk Ceyhun Gün\\
				}
				\column{2.5cm}
				\centering
				\visible<4->{
					\includegraphics[width=2.0cm]{images/necla.jpg}\\
					Necla Mutlu\\
				}
				\medskip
				\visible<8->{
					\includegraphics[width=2.0cm]{images/eralp.jpg}\\
					Halil Eralp Koçaş\\
				}
			\end{columns}
		\end{frame}
		...
		\begin{frame}{What Will We Do?}
			\LARGE
			\pause
			\texttt{\textbf{Lecture} Tuesday 14:30-15:45} @SNA 158
			\begin{itemize}
				\item New concepts about Python \& programming in general
				\item 
			\end{itemize}
			\pause
			\texttt{\textbf{Section}}
			\begin{itemize}
				...
				\item You will receive a Form with possible Section slots 
				\item Please select \textbf{every} option that suits you
				\item Exercise questions for \textbf{you} to solve
			\end{itemize}
			We need your feedback to get better, don't hesitate to talk with us!
		\end{frame}
