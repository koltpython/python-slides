...
\begin{document}
    ...
    \begin{frame}{Example: World Happiness Report 2019}

        \includegraphics[width=0.9\textwidth]{images/world_happiness_report.png}
        \huge
        Open \href{https://repl.it}{\underline{\textit{repl.it}}} to code along.
