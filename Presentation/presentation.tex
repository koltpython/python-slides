...
\newdate{date}{19}{12}{2019}
\date{\displaydate{date}}
\author{Ahmet Uysal}

\titlegraphic{\centering\includegraphics[height=1.2cm]{images/vpaa_logo.png}~~\includegraphics[height=1.1cm]{images/kolt_logo.png}}
...
\begin{document}
  ...
  \section{Team}
    ...
    \section{Certificate Program}
      ...
      \begin{frame}
        \frametitle{Curriculum (Fall 2019)}
        \large
    ...
    \begin{frame}{Future Goals}
      ...
      \begin{frame}{Advanced \& Diversed Curriculum}
        \pause
        \LARGE
