...
\titlegraphic{\centering\includegraphics[height=1.8cm]{images/vpaa_logo.png}\includegraphics[height=1.4cm]{../KU-Beamer-Template/style/images/logo_kolt.pdf}}
    ...
    \section{Certificate Program}
      ...
      \begin{frame}
        ...
        \begin{table}[]
          ...
          \textbf{18.11.2019} & Using third-party packages \\ \hline
          \textbf{25.11.2019} & TBD* \\ \hline
          \textbf{02.12.2019} & TBD* \\ \hline
          \textbf{09.12.2019} & TBD* \\ \hline
          \end{tabular}}
          \end{table}
        
          *TBD: Workshops will be offered in selected topics and packages.
      ...
      \begin{frame}
        \frametitle{Application Statistics}
