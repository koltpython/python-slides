    ...
    \section{Branching}
        \begin{frame}{Branching}
            ...
            \begin{center}
                ...
                \end{tikzpicture}
                \\
                \includegraphics[width=0.25\textwidth]{images/milk_bottle.png}
                \includegraphics[width=0.25\textwidth]{images/lion.png}
                \includegraphics[width=0.15\textwidth]{images/ayran.png}
            \end{center}
        \end{frame}
    ...
    \section{Basic Functions}
        ...
        \begin{frame}[c]{Functions}
            ...
            \begin{tikzpicture}[remember picture,overlay]
                ...
                \includegraphics[width=0.5\textwidth]{images/reduce_reuse_recycle.png}};
            \end{tikzpicture}
            \end{center}
        \end{frame}
